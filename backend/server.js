...
app.post('/submitform', (req, res) => {
    ...
    const transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'aurassance@gmail.com', // Your email address
            pass: 'mtsp onbz xits yzqz' // Your app password
        }
    });

    // Setup email data
    const mailOptions = {
        from: 'aurassance@gmail.com', // Sender address
        to: 'aurassance@gmail.com', // List of recipients
